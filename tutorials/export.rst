...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    pkg_path /tmp/tmp016f8loh/model.pt2
    tensor(1)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [torch.onnx] Optimize the ONNX graph... ✅
    ONNX rollout took 633.7147 msec (total =  0.6337 sec since last reset).
    TorchRL version took 2075.0101 msec (total =  2.0750 sec since last reset).
